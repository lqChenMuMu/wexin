...
import com.cl.wechat.base.advanced.model.Article;
import com.cl.wechat.base.advanced.model.Music;
...
public class MakeCustomMessage {	
	...
	public static String makeMusicCustomMessage(String openId,Music music) {
		...
		jsonMsg=String.format(jsonMsg, openId,JSONUtil.parse(music).toString());
		return jsonMsg;
	} 
	...
	public static String makeNewsCustomMessage(String openId,List<Article> articleList) {
		...
		jsonMsg=String.format(jsonMsg, openId, JSONUtil.parse(articleList).toString().replace("\"", "\\\""));
		return jsonMsg;
	} 
}
