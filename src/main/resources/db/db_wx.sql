...
CREATE TABLE `appointment` (
  ...
  `class_id` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `time` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `telphone` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `submit_time` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `is_delete` int(11) DEFAULT NULL,
  `validate_code` varchar(20) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `class_material` (
  ...
  `material_id` bigint(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `first_class` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `class_name` varchar(100) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `material` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `material_text` varchar(255) NOT NULL,
...
CREATE TABLE `second_class` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `class_name` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `first_class_id` bigint(11) DEFAULT NULL,
  `details` varchar(500) COLLATE utf8_bin DEFAULT NULL,
  `remark` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
