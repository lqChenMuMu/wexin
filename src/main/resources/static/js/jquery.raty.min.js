...
;(function (b) {
    var a = {
        init: function (c) {
            ...
            var e = b(this), c = this.opt.path + this.opt.cancelOff,
                d = b("<img />", {src: c, alt: "x", title: this.opt.cancelHint, "class": "raty-cancel"});
    ...
    b.fn.raty.defaults = {
        ...
        cancelOff: "../img/star/cancel-off.png",
        cancelOn: "../img/star/cancel-on.png",
        cancelPlace: "left",
        click: undefined,
        half: false,
        halfShow: true,
